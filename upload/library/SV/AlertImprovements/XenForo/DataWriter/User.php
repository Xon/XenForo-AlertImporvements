...
class SV_AlertImprovements_XenForo_DataWriter_User extends XFCP_SV_AlertImprovements_XenForo_DataWriter_User
{
    protected function _getFields()
    {
        ...
        $fields['xf_user_option']['sv_alerts_page_skips_summarize'] = array('type' => self::TYPE_BOOLEAN, 'default' => 0);
        $fields['xf_user_option']['sv_alerts_summarize_threshold'] = array('type' => self::TYPE_INT, 'default' => 0);
        return $fields;
    }
}
